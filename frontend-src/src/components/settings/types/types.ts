...
export type ClaudeAccountSettingsState = {
  command: string;
  model: string;
  thinkingEffort: ProviderThinkingEffort;
};

export type CodexAccountSettingsState = {
  command: string;
  model: string;
...
export type SettingsStoragePayload = {
  claude: ClaudePermissionsState & ClaudeAccountSettingsState & {
    projectSortOrder: ProjectSortOrder;
    lastUpdated: string;
  };
  codex: CodexAccountSettingsState & {
