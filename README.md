...
6. Double-click the app file to start VibeBridge.
7. If Windows asks for permission, choose Yes.
8. Wait for the app to open in your browser or local window.
9. Keep the app running while you use it.
...
1. Open the VibeBridge web UI.
2. Find the node or machine section.
...
6. Check that your nodes still connect
